...
int main()
{
	...
	*/
	...
	glm::mat4 modelaux(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía del brazo
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//ARTICULACION DE LA LLANTA DELANTERA IZQUIERDA
		...
		//*****************
		//ARTICULACION DE LA LLANTA DELANTERA DERECHA
		model = glm::translate(model, glm::vec3(-3.0f, -1.5f, -2.5f));
		//rotación alrededor de la articulación que une con la base
		...
		//*****************
		//ARTICULACION DE LA LLANTA TRASERA IZQUIERDA
		model = glm::translate(model, glm::vec3(3.0f, -1.5f, 2.5f));
		//rotación alrededor de la articulación que une con la base
		...
		//*****************
		//ARTICULACION DE LA LLANTA TRASERA DERECHA
		model = glm::translate(model, glm::vec3(3.0f, -1.5f, -2.5f));
		//rotación alrededor de la articulación que une con la base
